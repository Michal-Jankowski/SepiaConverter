...
namespace SepiaDll // przestrzeń nazw SepiaDll
{
    ...
    public class Sepia
    {
        ...
        /// PARAMETRY WEJŚCIOWE TO: object args
        ...
        public static void  CSharpDllFunc(object args)
        {
            ...
            arguments = (Array)args;
                                                                 ...
                                                                 //  zapisywanie do zmiennej początek przedziału tablicy bajtów dla danego watku
            ...
            int depthValue = (int)arguments.GetValue(4);         
                                                                 ...
                                                                 // SKOK W PETLI CO 32 WARTOSCI, czyli 8 pikseli
            for (int i = RGBstart; i <= RGBstop - 32; i += 32)
            {
                ...
                rgbValues[i + 30] = (byte)average;
                                                             ...
                                                             // UZYSKANO EFEKT SZAROŚCI PO ZAKOŃCZENIU 1. PĘTLI
                                                                ...
                                                                // NASTĄPI W TEJ PĘTLI SPRAWDZENIE KILKU WARUNKÓW IF, aby odpowiednio usyzskać koloryzacje obrazu odbpowiednią barwą, aby otrzy efekt sepii
            for (int i = RGBstart; i <= RGBstop - 4; i += 4)
            {
                ...
                if (rgbValues[i + 2] > (255 - 2 * sepiaValue))  // warunek sprawdzający czy przekroczono wartość 255 dla koloru czerwonego
                    ...
                    rgbValues[i + 2] += (byte)(2 * sepiaValue); // dodanie podwójnej wartości  składowej wypełnienia do wartości koloru czerwonego piksela, wynikające z algorytmu
                                                               ...
                                                               // Zakońzcono II etap programu, proces konwersji obrazu zakończony
        }
